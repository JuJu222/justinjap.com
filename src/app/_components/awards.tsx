...
function Awards() {
  return (
    <FadeIn delay={0.3} className='w-full max-w-6xl mt-12 md:mt-20' enableInView>
      ...
      <p className='text-muted-foreground text-sm md:text-base mt-2'>Achievements and recognitions I have received.</p>
      <ul className='list-disc list-inside mt-4 space-y-2 md:space-y-3'>
        <li className='text-muted-foreground text-sm md:text-base'>
